...
ground=box(pos=vector(0,0,0),size=vector(4.5,0.02,0.25), color=color.white)
...
ball.m=0.05
v0=7.2
theta=43*math.pi/180
ball.p=ball.m*v0*vector(cos(theta),sin(theta),0)
vscale=.1
#varrow=arrow(pos=ball.pos,axis=vscale*ball.v , color=color.blue)
